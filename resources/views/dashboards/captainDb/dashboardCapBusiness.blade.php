            ...
            <tbody>
                @foreach($permits as $permit)
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ExtralargeModal" data-type="business" data-id="{{ $permit->id }}">View</button>
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    <div class="modal fade" id="ExtralargeModal" tabindex="-1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-4 label">Business Name:</div>
                    <div class="col-lg-9 col-md-8" id="businessName"></div>
                </div>

                <div class="row">
                    <div class="col-lg-2 col-md-4 label">Business Address:</div>
                    <div class="col-lg-9 col-md-8" id="businessAddress"></div>
                </div>

                <div class="row">
                    <div class="col-lg-2 col-md-4 label">Business Type:</div>
                    <div class="col-lg-9 col-md-8" id="businessType"></div>
                </div>

                <div class="row">
                    <div class="col-lg-2 col-md-4 label">Business Nature:</div>
                    <div class="col-lg-9 col-md-8" id="businessNature"></div>
                </div>
