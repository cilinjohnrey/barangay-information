...
@section('style')
    <link rel="stylesheet" href="{{ asset('css/businessClearance.css') }}">
                        ...
                        <div class="rightsContainer">
                            ...
                            <div class="bodyLetter">
                                <p class="paragraph1">This is to certify that the undersigned hereby approved the application of <b>{{ $certificate->res_fname }} {{ $certificate->res_mname }} {{ $certificate->res_lname }}</b>
                                    for a business permit to operate the business named as <b> {{ $certificate->bc_businessName }}</b> located at Purok 
                                    <span>{{ $certificate->res_purok }}, Sitio {{ $certificate->res_sitio }},</span> Barangay Poblacion Ward II Minglanilla, Cebu.</p>
    ...
    <div class="rephraseMainBg">
        <form id="updateForm" class="rephraseForm" method="POST" action="{{ route('updateBusinessTransaction', ['id' => $certificate->id]) }}">
            ...
            <div class="rephrasePurpose">
                <label for="rephrasePurpose">Business Name</label>
                <textarea name="rephrasePurpose" id="rephrasePurpose" class="inputForms"></textarea>
