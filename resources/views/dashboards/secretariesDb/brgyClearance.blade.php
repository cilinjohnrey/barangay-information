...
@section('style')
    <link rel="stylesheet" href="{{ asset('css/brgyClearance.css') }}">
    ...
    <div class="rephraseMainBg">
        <form id="updateForm" class="rephraseForm" method="POST" action="{{ route('updateBrgyClearance', ['id' => $certificate->clearance_bcl_id]) }}">
            ...
            <div class="rephrasePurpose">
                <label for="rephrasePurpose">Purpose</label>
                <textarea name="rephrasePurpose" id="rephrasePurpose" class="inputFormsTxt"></textarea>
